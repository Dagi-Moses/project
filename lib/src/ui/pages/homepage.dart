...
import 'package:project/src/models/office.dart';
...
FirebaseAuth auth = FirebaseAuth.instance;
    ...
    try {
      ...
      switch (result) {
        case PermissionStatus.granted:
          officeDatabase.getOfficeBasedOnUID(auth.currentUser!.uid).then((office) {
  ...
  void initState() {
    ...
    firebaseMessaging.getToken().then((token) {
      _databaseReference.child("users").child(auth.currentUser!.uid).update({
