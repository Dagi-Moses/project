...
import 'package:project/src/services/attendance_mark.dart';
import 'package:project/src/services/fetch_offices.dart';
import 'package:project/src/services/geofencing.dart';
import 'package:project/src/ui/constants/colors.dart';
import 'package:project/src/ui/widgets/attendance_Marker_buttons.dart';
...
class AttendanceRecorderWidget extends StatefulWidget {
  ...
  const AttendanceRecorderWidget({super.key, required this.user});
...
class AttendanceRecorderWidgetState extends State<AttendanceRecorderWidget> {
  ...
  double zoomVal = 5.0;
  OfficeDatabase officeDatabase = OfficeDatabase();
  ...
  Widget googleMap(BuildContext context) {
    double _initialLat = 37.4219983;
    double _initialLong = -122.084;
