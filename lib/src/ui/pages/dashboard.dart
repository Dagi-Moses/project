...
import 'package:project/src/ui/constants/dashboard_tile_info.dart';
import 'package:project/src/ui/pages/pending_approval_manager.dart';
import 'package:project/src/ui/pages/profile_page.dart';
import 'package:project/src/ui/widgets/dashboard_tile.dart';
...
class DashboardMainPanel extends StatelessWidget {
  ...
  List<StaggeredTile> _staggeredTiles() {
    ...
    tileData.forEach((tile) {
     widgets.add(StaggeredTile.extent( 1,210,));
    });
