                              ...
                              children: [
                                ...
                                GroupButton(
                                  ...
                                  unselectedTextStyle: TextStyle(
                                    fontWeight: FontWeight.w600,
                                    color: dashBoardColor.withOpacity(0.5),
                                  ),
                                  ),
                                  isRadio: false,
                                  onSelected: (Checked,Index, isSelected) {
                                    print(
                                        "index: $Index   isSelected: $isSelected");
                                    setState(() {
                                      isSelected = true;
                                      leaveIndex = Index;
                                        _checked= Checked as List<String>;
                                    });
                                  },
                                  buttons: <String>[
                                    leaveType[0],
                                ...
                                TextField(
                                  ...
                                  // IonSubmitted: _giveData(emailController),
...
//                                                duration: Duration(seconds: 1),
                                                ...
                                                SnackBar error = new SnackBar(
                                                  content: Text(
                                                      "You have enough requested leaves",
                                                      style: TextStyle(
                                                          color: Colors.white)),
